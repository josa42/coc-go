...
| ‣ `deepCompletion`              | **EXPERIMENTAL** deepCompletion If true, this turns on the ability to return completions from deep inside relevant entities, rather than just the locally accessible ones. | true                    |
...
| ‣ `symbolMatcher`               | **EXPERIMENTAL** symbolMatcher sets the algorithm that is used when finding workspace symbols.                                                                             | SymbolFuzzy             |
| ‣ `symbolStyle`                 | **EXPERIMENTAL** symbolStyle specifies what style of symbols to return in symbol requests.                                                                                 | PackageQualifiedSymbols |
